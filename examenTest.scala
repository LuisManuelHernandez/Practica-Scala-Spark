...
class examenTest extends TestInit {
  ...
  "Ejercicio 5" should "calcula el ingreso total" in {
    ...
    val ventas = spark.read
      ...
      .csv("C:\\Users\\PREDATOR\\Desktop\\BOOTCAMP BIG DATA\\bd-processing\\src\\main\\scala\\examen_estructura\\ventas.csv")

    val out = ejercicio5(ventas).collect().map(row => (row.getInt(0), row.getDouble(1))).sorted
    out.toList shouldBe List((101,460.0), (102,405.0), (103,280.0),
      (104,800.0), (105,570.0), (106,425.0),
      (107,396.0), (108,486.0), (109,540.0),
      (110,494.0))
  }
